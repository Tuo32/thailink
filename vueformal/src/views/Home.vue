...
export default {
  ...
  methods:{
    pieChartConfigure(){
      request.get("https://"+this.$server+"/chart/pie").then(res => {
    ...
    financeLineChartConfigure(){
      request.get("https://"+this.$server+"/finance/chart/line?startDate=" + this.financeLineChartStartDate + "&endDate=" + this.financeLineChartEndDate ).then(res => {
  ...
  return currentdate;
    ...
    financeSummary(){
      request.get("https://"+this.$server+"/finance/sum?startDate=" + this.financeLineChartStartDate + "&endDate=" + this.financeLineChartEndDate ).then(res => {
