...
export default {
  ...
  created() {
    ...
    // }
    this.load()
    console.log("https://localhost/menu/page?pageNum="+this.pageNum+"&pageSize="+this.pageSize+"&menuName="+this.menuName)
  },
  methods: {
    collapse() {
    ...
    load() {
      request.get("https://localhost/menu/page?pageNum=" + this.pageNum + "&pageSize=" + this.pageSize + "&menuName=" + this.menuName).then(res => {
        console.log(res)
    ...
    save() {
      console.log("https://localhost:/user", JSON.stringify(this.form))
      request.post("https://localhost/menu", this.form).then(res => {
        if (res) {
    ...
    del(id) {
      request.delete("https://localhost/menu/" + id).then(res => {
        if (res) {
    ...
    delBatch() {
      ...
      request.post("https://localhost/menu/del/batch", ids).then(res => {
        if (res) {
